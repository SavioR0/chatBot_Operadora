pergunta(1, Resposta, Numero, Clien):-
    plano(Numero, Plan)-> format("Já possui um plano cadastrado : Plano "), write(Plan), nl, chatbot(Numero, Clien);(
...
pergunta(4,"Solicitação de renovação do plano realizada com sucesso", Numero, Clien ):-
